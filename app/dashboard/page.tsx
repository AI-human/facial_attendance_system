...
export default function DashboardPage() {
  return (
    <main className="shell">
      <nav className="nav"><Link className="brand" href="/">face-edu</Link><div className="navlinks"><Link href="/enroll">Enroll</Link><Link href="/check-in/demo-session">Check in</Link></div></nav>
